...
const faqs = [
  {
    ...
    a: 'We welcome both walk-ins and appointments. However, booking via WhatsApp guarantees your preferred time slot and avoids waiting. Message us on 0306-5055467 to reserve your spot.',
  },
  {
    q: 'Where exactly is Ace of Fades located?',
    a: "We're located at Cheema Town Chowk, Gulberg Road, Bahawalpur — near Al-Kifayah Super Mart, Cheema Town. Easy to find and conveniently accessible.",
  },
  {
  ...
  },
  {
    ...
    a: 'We accept cash and bank transfers. For queries, contact via WhatsApp or call 0306-5055467.',
  },
];
      ...
      <div className={styles.container}>
        ...
        <div className={styles.sidebar}>
          <div className={styles.sidebarCard}>
            ...
            <a href="https://wa.me/923065055467" target="_blank" rel="noopener noreferrer" className={styles.waBtn}>
            ...
            <a href="tel:03065055467" className={styles.callBtn}>
              <Phone size={18} />
              0306-5055467
            </a>
          </div>
